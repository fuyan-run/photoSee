 ...
 * 移动端和pc端的兼容
 * 
 * 鼠标按下 mousedown  移动端touchstart
 * 鼠标移动 mousemove  移动端touchmove
 * 鼠标抬起 mouseup    移动端touchend
 * 
 **/
